...
object EventParticipantServiceImpl : EventParticipantService {
    ...
    override suspend fun <T: EventParticipant> addParticipant(rootPath: RootPath, eventId: String, participant: T): T {
    ...
    override suspend fun <T: EventParticipant> getAllParticipants(rootPath: RootPath, eventId: String, clazz: Class<T>): Flow<List<T>> {
        checkArgument(eventId.isNotBlank(), "The event id cannot be blank")
    ...
    override suspend fun removeParticipant(rootPath: RootPath, eventId: String, participantId: String) {
        checkArgument(eventId.isNotBlank(), "The event id cannot be blank")
